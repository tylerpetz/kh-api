 ...
 *     description: Only admins can create lists for others.
 *     tags: [Lists]
 *     security:
 *       - bearerAuth: []
 *     requestBody:
 ...
 *   get:
 *     summary: Get a list
 *     description: Logged in users can fetch only their own list information. Only admins can fetch other lists.
 *     tags: [Lists]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     description: Logged in users can only update their own information. Only admins can update other lists.
 *     tags: [Lists]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     description: Logged in users can delete only their own lists. Only admins can delete other lists.
 *     tags: [Lists]
 *     security:
 *       - bearerAuth: []
 *     parameters:
